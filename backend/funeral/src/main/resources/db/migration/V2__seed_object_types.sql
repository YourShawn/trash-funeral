-- Object-type funeral scripts. DataSeeder also upserts these at boot so H2/local stays in sync.

INSERT INTO object_types (code, name_zh, name_en, eulogy_zh, eulogy_en, default_music, default_flowers, throw_hint_zh, throw_hint_en)
VALUES
('ELECTRONICS', '电子遗物', 'E-waste spirit',
...
('COSMETICS', '空瓶仙', 'Empty-bottle immortal',
